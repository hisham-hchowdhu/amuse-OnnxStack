...
namespace OnnxStack.StableDiffusion.Diffusers.StableDiffusion3
{
    public abstract class StableDiffusion3Diffuser : StableDiffusionXLDiffuser
    {
        ...
        protected StableDiffusion3Diffuser(UNetConditionModel unet, AutoEncoderModel vaeDecoder, AutoEncoderModel vaeEncoder, MemoryModeType memoryMode, ILogger logger = default)
        ...
        public override async Task<DenseTensor<float>> DiffuseAsync(PromptOptions promptOptions, SchedulerOptions schedulerOptions, PromptEmbeddingsResult promptEmbeddings, bool performGuidance, Action<DiffusionProgress> progressCallback = null, CancellationToken cancellationToken = default)
        {
            ...
            using (var scheduler = GetScheduler(schedulerOptions))
            {
                ...
                foreach (var timestep in timesteps)
                {
                    ...
                    var outputDimension = schedulerOptions.GetScaledDimension(batchCount, 16);
